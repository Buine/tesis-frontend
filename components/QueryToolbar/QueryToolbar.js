...
export default function QueryToolbar() {
  const { queryBuilderData, setQueryBuilderData, valuesUi, setQueryResult, dataUi, queryResult } = useQueryBuilderContext()
  ...
  function saveQuery() {
    ...
    if (queryResult.time == undefined) {
      ...
      copy["json"] = { 
        queryBuilderData, valuesUi, dataUi, queryResult
      }
  ...
  return <div className={styles.container}>
    ...
    <div className={styles.tools}>
      ...
      <div className={styles.save_button} onClick={() => saveQuery()}>
        Save Query
      </div>
    </div>
  </div>
